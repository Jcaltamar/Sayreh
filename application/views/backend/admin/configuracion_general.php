        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('Licencia Nro.');?></label>
                      <div class="col-sm-9">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo get_phrase('Actualización');?>
                </div>
            </div>
            ...
            <div class="panel-body form-horizontal form-groups-bordered">
                <?php echo form_open(base_url().'index.php?updater/update' , array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('Archivo'); ?></label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <input type="submit" class="btn btn-info" value="<?php echo get_phrase('Instalar Actualización'); ?>" />
                        </div>
                    </div>
