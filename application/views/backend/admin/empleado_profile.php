                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" class="btn btn-info btn-sm"
                                    onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/complaints_add/<?php echo $row['user_code'];?>')">
                                    ...
                                    <div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
                            			...
                            			<div class="panel-body">
                                            ...
                                            <a href="#" class="btn btn-default btn-sm"
                                                onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/complaint_edit/<?php echo $complaint['complaints_id'];?>')">
                                                <i class="entypo-pencil"></i> &nbsp; <?php echo get_phrase('edit'); ?>
                                            </a>
                                            <a href="#" class="btn btn-default btn-sm"
                                                onclick="confirm_modal_hard_reload('<?php echo base_url(); ?>index.php?admin/employee/complaint_delete/<?php echo $complaint['complaints_id']; ?>')">
