<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/planta_add/');" 
   class="btn btn-primary pull-right">
    ...
    <?php echo get_phrase('Adicionar Nuevo Planta'); ?>
</a> 
<br><br><br>
             ...
             <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                            <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/planta_edit/<?php echo $row['PLANTA_CODIGO']; ?>');">
                        ...
                        <li>
                            <a href="#" onclick="confirm_modal_hard_reload('<?php echo base_url(); ?>index.php?admin/planta/delete/<?php echo $row['PLANTA_CODIGO']; ?>');">
