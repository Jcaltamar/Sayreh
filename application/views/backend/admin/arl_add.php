        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title" >
                    ...
                    <?php echo get_phrase('Adicionar Porcentaje'); ?>
                </div>
            </div>
            <div class="panel-body">

                <?php echo form_open(base_url() . 'index.php?admin/arl/create',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="porcentaje" value="" required autofocus />
                    </div>
                </div>				
