		...
		<div class="row">
			...
			<div class="col-md-4">
                ...
                <div class="tile-stats tile-red">
                    ...
                    <div class="num" data-start="0" data-end="<?php echo $this->db->get_where('empleado', array('PAIS_CODIGO' => 1))->num_rows(); ?>" 
                    		data-postfix="" data-duration="1500" data-delay="0">0</div>
                    
                    <h3><?php echo get_phrase('Total Empleados');?></h3>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-green">
                    ...
                    <h3><?php echo get_phrase('Activos');?></h3>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-aqua">
                    ...
                    <h3><?php echo get_phrase('Vacaciones/Licencia');?></h3>
                </div>
