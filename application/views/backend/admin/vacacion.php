<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/vacacion_add');" 
   class="btn btn-primary pull-right">
    <i class="entypo-plus-circled"></i>
    <?php echo 'Adicionar Vacaciones'; ?>
</a> 
<br><br><br>
...
<table class="table table-bordered" id="table_export">
    <thead>
        <tr>
			...
			<th><div><?php echo 'Fecha Final'; ?></div></th>
    ...
    <tbody>
		...
		$this->db->where('LIQ_TIPO_CONCEPTO', 'V');
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/vacacion_edit/<?php echo $row['vacancy_id']; ?>');">
                            ...
                            <li>
                                <a href="#" onclick="confirm_modal_hard_reload('<?php echo base_url(); ?>index.php?admin/vacacion/delete/<?php echo $row['vacancy_id']; ?>');">
