<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/libranza_add');" 
   class="btn btn-primary pull-right">
    <i class="entypo-plus-circled"></i>
    <?php echo 'Adicionar Libranza'; ?>
</a> 
<br><br><br>
...
<table class="table table-bordered" id="table_export">
    ...
    <tbody>
		...
		$this->db->where('LIQ_TIPO_CONCEPTO', 'L');
        ...
        foreach ($novedades as $row):
            ...
            <tr>
				...
				<td><?php echo $nombreentidad=$this->db->get_where('tercero' , array('ETB_CODIGO' =>$row['COD_ENTIDAD']))->row()->ETB_NOMBRE; ?> </td>

				
				<td><?php echo $row['LIQ_FECHA_INI']; ?></td>
				<td><?php echo number_format($row['LIQ_VALOR_CONCEPTO'],2,'.',','); ?></td>
				<td><?php echo number_format($row['LIQ_CUOTAS'],2,'.',','); ?></td>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/libranza_edit/<?php echo $row['EMP_CEDULA']; ?>');">
                            ...
                            <li>
                                <a href="#" onclick="confirm_modal_hard_reload('<?php echo base_url(); ?>index.php?admin/libranza/delete/<?php echo $row['EMP_CEDULA']; ?>');">
