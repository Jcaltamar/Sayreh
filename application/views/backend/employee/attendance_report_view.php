...
<?php echo form_open(base_url() . 'index.php?employee/attendance_report_selector'); ?>
...
<?php if($year != '' && $month != '') { ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <center>
                <a href="<?php echo base_url(); ?>index.php?employee/attendance_report_print_view/<?php echo $year; ?>/<?php echo $month; ?>"
